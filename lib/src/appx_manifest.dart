    ...
    <Applications>
      <Application Id="${_config.appName!.replaceAll('_', '')}" Executable="${_config.executableFileName.toHtmlEscape()}" EntryPoint="Windows.FullTrustApplication">
        <uap:VisualElements BackgroundColor="transparent"
          DisplayName="${localizedAppNameKey.toHtmlEscape()}" Square150x150Logo="Images\\Square150x150Logo.png"
          Square44x44Logo="Images\\Square44x44Logo.png" Description="${localizedAppDescKey.toHtmlEscape()}">
          <uap:DefaultTile ShortName="${localizedAppNameKey.toHtmlEscape()}" Square310x310Logo="Images\\LargeTile.png"
